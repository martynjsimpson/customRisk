...
describe("BUG-005 — Review button conditional on reviewStatus", () => {
  test("is conditional on reviewStatus !== NOT_REQUIRED", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("is not rendered unconditionally for all risks", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("Edit button is always rendered regardless of reviewStatus", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("imports reviewStatus from DashboardRisk type", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
...
describe("UI-005 — Search and filter bar on /my-risks", () => {
  test("uses useSearchParams to read filter state", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("passes filters to getMyRisks", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("renders search, state, risk level, and register filter inputs", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("has a Reset button that clears all filters", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("getMyRisks API function accepts a MyRisksQuery parameter", async () => {
...
describe("UI-006 — Export CSV button on /my-risks", () => {
  test("imports exportMyRisks from dashboard.api", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("exportMyRisks is exported from dashboard.api.ts", async () => {
    const api = await readFile(
      new URL("../src/api/dashboard.api.ts", import.meta.url),
      "utf8"
    );
  ...
  test("exportMyRisks accepts the same query params as getMyRisks", async () => {
    const api = await readFile(
      new URL("../src/api/dashboard.api.ts", import.meta.url),
      "utf8"
    );
  ...
  test("renders an Export CSV button", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("Export CSV button passes active filters to exportMyRisks", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
  ...
  test("export error is displayed to the user", async () => {
    const page = await readFile(
      new URL("../src/features/myRisks/MyRisksPanel.tsx", import.meta.url),
      "utf8"
    );
